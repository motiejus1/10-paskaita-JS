...
document.getElementById("kvadrato-perimetras").innerText = kvadratas.plotasPerimetras()[1];
document.getElementById("kvadrato-plotas").innerText = kvadratas.plotasPerimetras()[0];
document.getElementById("kvadrato-istrizaine").innerText = kvadratas.plotasPerimetras()[0];